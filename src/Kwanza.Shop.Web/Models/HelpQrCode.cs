    ...
    public class HelpQrCode : Controller
    {
        ...
        public async Task<IActionResult> Download(CompraUsuario compraUsuario, IWebHostEnvironment _environment)
        {
            ...
            using (var doc = new PdfSharpCore.Pdf.PdfDocument())
            {
                ...
                var logoFatura = string.Concat(webRoot, "/img/", "loja-logo.png");
                ...
                relatorioCobranca.DrawString("FACTURA ONLINE", titulo, corFonte, new XRect(0, 65, page.Width, page.Height));
                ...
                detalhes.DrawString("Banco Bai 0040", tituloInfo_1, corFonte, new XRect(150, alturaTituloDetalhesY, page.Width, page.Height));
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    return File(stream.ToArray(), contentType, "FacturaKwanzaShop.pdf");
                }
